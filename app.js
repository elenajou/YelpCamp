...
app.use(express.urlencoded({ extended: true }));//parses the body from POST
...
//use LocalStrategy and authenticate it with the User model
...
//     const user = new User({email: 'yelpcamp@gmail.com', username: 'yelpcamp3'})
//     const newUser = await User.register(user, 'chickennugget');
//     res.send(newUser);
// })
